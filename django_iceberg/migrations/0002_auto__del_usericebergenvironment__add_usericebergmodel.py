...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'django_iceberg_usericebergmodel', (
            ...
            ('environment', self.gf('django.db.models.fields.CharField')(default='sandbox', max_length=20)),
            ('last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('iceberg_username', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('access_token', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('sso_data', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('application_namespace', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('language', self.gf('django.db.models.fields.CharField')(default='en', max_length=10)),
            ('shipping_country', self.gf('django.db.models.fields.CharField')(default='FR', max_length=10)),
            ('currency', self.gf('django.db.models.fields.CharField')(default='EUR', max_length=3)),
        ))
        db.send_create_signal(u'django_iceberg', ['UserIcebergModel'])
    ...
    models = {
        ...
        u'django_iceberg.usericebergmodel': {
            ...
            'application_namespace': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'currency': ('django.db.models.fields.CharField', [], {'default': "'EUR'", 'max_length': '3'}),
            'environment': ('django.db.models.fields.CharField', [], {'default': "'sandbox'", 'max_length': '20'}),
            'iceberg_username': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'default': "'en'", 'max_length': '10'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'shipping_country': ('django.db.models.fields.CharField', [], {'default': "'FR'", 'max_length': '10'}),
            'sso_data': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'})
        }
    }

    complete_apps = ['django_iceberg']